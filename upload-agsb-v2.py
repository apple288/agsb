...
UUID = "235958cc-ce4b-45e9-8e0d-6ef906f78dfb"                     # UUID，留空则自动生成
PORT = 40607                   # Vmess端口，留空或0则自动生成
DOMAIN = "sl.swk1.ip-ddns.com"                   # 域名，留空则自动获取
CF_TOKEN = "eyJhIjoiY2Q2OTUyZDhiZDg5NDkwODQzYWM1YjAwYWE1N2IyYTUiLCJ0IjoiNzBhNTEyNWItNzVhYy00ZGYyLTkwNTYtZmYyOGY2Yzg4MzMyIiwicyI6Ik9HUXpZamhtWkdVdE0yTTBOaTAwTldNMkxUa3laR0V0TnpOaE9XRTBPV1pqTXpZMSJ9"                 # Cloudflare Token，留空则用Quick Tunnel
# =========================================
